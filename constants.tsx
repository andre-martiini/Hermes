...
export const PROJECT_COLORS: Record<string, string> = {
  ...
  'CARREIRA': 'text-blue-700 font-black',
  'FINANCAS': 'text-emerald-700 font-black',
  'FINANÇAS': 'text-emerald-700 font-black',
  'SAUDE': 'text-rose-600 font-black',
  'SAÚDE': 'text-rose-600 font-black',
  'INTELECTUAL': 'text-amber-600 font-black',
  'ESTILO DE VIDA': 'text-cyan-700 font-black',
