...
flags:
  ...
  depois: {}
pendencias:
  - "ABERTA: PR #254 aguardando merge do Andre -- esta entrada esta em pronto_para_revisao, nao validado; uma execucao futura desta tarefa agendada deve conferir se foi mesclada (git clone publico + git log/git branch -r) e atualizar estado/evidencias aqui, sem reescrever um bloco ja validado."
