...
# REMOVIDO (17/09/2026): on_tarefa_written_extract_people -- gatilho em toda
# criacao/edicao de tarefa que extraia nomes de pessoas via Gemini e gravava
# interacoes_pessoas. Era a funcao mais cara do sistema (~US$60/mes, ~90% do
# custo de Gemini do Hermes) porque reenviava titulo+descricao+diario INTEIRO
# a cada edicao, sem limite de historico (diferente de montar_texto_fonte_contexto,
# que ja corta em limite_diario). Substituido por POP: o Claude, ao criar/editar
# uma acao pela sessao, usa buscar_contato/preparar_vinculo_contatos/
# registrar_interacao_contato (tools MCP ja existentes) para o mesmo efeito, sem
# custo de API adicional -- so deixa de ser automatico fora de uma sessao do
# Claude. interacoes_pessoas/perfil_pessoas continuam existindo e sendo lidos
# normalmente; whatsapp_consolidation.py continua escrevendo interacoes do
# WhatsApp. Ver ata de decisao no diario da acao b066fbd2-8552-4321-b.
