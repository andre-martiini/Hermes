...
_INSTRUCTIONS = (
    ...
    "Depois de confirmado, ainda da para cancelar com "
    "`cancelar_envio_whatsapp(job_id)` enquanto o status for `pending` ou "
    "`notified` (consulte com `consultar_envio_whatsapp`) — uma vez `sent`, "
    "ai sim nao ha como desfazer. Para reagendar, cancele e chame "
    "`schedule_whatsapp_message` de novo com o novo horario.\n"
