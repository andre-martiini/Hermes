...
class InboxPendentesTest(unittest.TestCase):
    ...
    def test_grupos_aplicam_regra_fina_e_motivo(self):
        db = Db({'system': {'settings': {'whatsapp_ingest': {'chats_allowlist': ['a', 'b', 'c', 'd'], 'andre_chat_ids': ['andre@c.us']}}},
                 'perfil_pessoas': {}, 'email_action_suggestions': {},
        ...
        self.assertEqual({x['contato']: x['motivo_inclusao'] for x in result}, {'a': 'mencao', 'c': 'grupo_vinculado', 'd': 'resposta_a_mim'})
