...
O instalador valida a senha localmente, executa a primeira sincronização e cria a tarefa `Hermes Allcare Local Agent`, no logon e a cada 6 horas. O computador precisa estar ligado e conectado. O log fica em `%LOCALAPPDATA%\Hermes\allcare-agent.log`.

Para remover apenas a tarefa agendada, execute no PowerShell:
