...
gcloud run deploy hermes-voice-bridge `
  ...
  --port 8080 `
  --set-env-vars "^;^FIREBASE_PROJECT_ID=gestao-hermes;HERMES_TIMEZONE=America/Sao_Paulo;GOOGLE_APPLICATION_CREDENTIALS=/secrets/firebase-service-account.json;HERMES_VOICE_ALLOWED_ORIGINS=https://gestao-hermes.web.app,https://gestao-hermes.firebaseapp.com,https://gaspar-assistente.web.app,https://gaspar-assistente.firebaseapp.com;HERMES_VOICE_MAX_IDLE_SECONDS=90;HERMES_VOICE_MAX_SESSION_SECONDS=900;HERMES_MCP_URL=https://us-central1-gestao-hermes.cloudfunctions.net/mcpServer" `
