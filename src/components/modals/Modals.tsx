    ...
    <div className="space-y-6 animate-in slide-in-from-right-4 duration-500">
      ...
      <div className={cardClass}>
        <ToggleRow
          ...
          desc="Todo dia às 21h30, gera um diário em primeira pessoa a partir das suas ações, saúde, finanças, agenda e conversas — entregue no Telegram para leitura e ajuste. Aos domingos, destila seu perfil pessoal e manda no Telegram o que percebeu, para você corrigir."
