                ...
                {file ? (
                  <>
                     ...
                     <div className="min-w-0 w-full">
                       <p className={`text-base md:text-lg font-black break-words ${primaryTextClass}`}>{file.name}</p>
               ...
               {transcription ? (
                 <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar space-y-6">
                   <div className="space-y-2">
                     <label className={`text-[10px] font-black uppercase tracking-widest ${tertiaryTextClass}`}>Texto Refinado</label>
                   ...
                   <div className={`pt-6 border-t space-y-2 opacity-60 hover:opacity-100 transition-opacity ${borderSoftClass}`}>
                     <label className={`text-[10px] font-black uppercase tracking-widest ${subtleTextClass}`}>Transcrição Bruta</label>
